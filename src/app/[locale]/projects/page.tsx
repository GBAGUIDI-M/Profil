    ...
    <div className="min-h-screen px-6 py-24 md:px-16 lg:px-24 max-w-6xl mx-auto">
      <header className="mb-16">
        ...
        <p className="text-lg md:text-xl font-light text-muted-foreground leading-relaxed max-w-2xl">
          Laboratory notebook entries documenting active investigations across pure mathematics, biomathematics, and computational science.
        </p>
      </header>
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              {project.math && (
                <div className="mt-auto pt-6 border-t border-border/50">
                  <div className="text-xs text-muted-foreground/60 uppercase tracking-widest mb-3">Mathematical Framework</div>
